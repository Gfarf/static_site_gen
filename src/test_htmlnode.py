...
class TestHTMLNode(unittest.TestCase):
    def test_print(self):
        ...
        node5 = HTMLNode()
        self.assertEqual(node.props_to_html(), ' href="link de referencia." target="alvo"')
        self.assertEqual(node2.props_to_html(), ' href="link de referencia." target="alvo"')
        self.assertEqual(node3.props_to_html(), "")
        self.assertEqual(node4.props_to_html(), "")
        self.assertEqual(node5.props_to_html(), "")
